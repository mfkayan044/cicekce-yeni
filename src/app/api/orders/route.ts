  ...
  try {
    ...
    if (orderId) {
      ...
      return NextResponse.json({
        ...
        deliveryTime: order.delivery_slot || order.delivery_time || order.deliveryTime || "",
        deliverySlot: order.delivery_slot || order.delivery_time || order.deliveryTime || "",
        items: itemsArr,
        addons: addonsArr,
    ...
    if (customerEmail || customerPhone) {
      ...
      const formattedMemberOrders = (memberOrders || []).map((o: any) => {
        ...
        return {
          ...
          deliveryTime: o.delivery_slot || o.delivery_time || o.deliveryTime || sbOrder.delivery_time || sbOrder.delivery_slot || "",
          deliverySlot: o.delivery_slot || o.delivery_time || o.deliveryTime || sbOrder.delivery_time || sbOrder.delivery_slot || "",
...
export async function POST(request: Request) {
  try {
    ...
    const newOrder = {
      ...
      delivery_time: orderData.deliveryTime || orderData.delivery_time || orderData.deliverySlot || orderData.delivery_slot || "",
      delivery_slot: orderData.deliverySlot || orderData.delivery_slot || orderData.deliveryTime || orderData.delivery_time || "",

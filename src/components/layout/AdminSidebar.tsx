...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Toplu Fiyat Güncelle", href: "/yonetim/toplu-fiyat-guncelle", icon: "bx bx-purchase-tag" },
      { title: "Özel Gün Hatırlatıcılar", href: "/yonetim/hatirlaticilar", icon: "bx bx-bell" },
      { title: "Kupon Yönetimi", href: "/yonetim/kuponlar", icon: "bx bx-purchase-tag-alt" },
      { title: "ÇiçekPuan Sadakat Sistemi", href: "/yonetim/sadakat-programi", icon: "bx bx-award" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Çiçek Aboneliği", href: "/yonetim/abonelik", icon: "bx bx-calendar-event" },

    ...
    <AdminLayout>
      <div className="space-y-6 font-sans">
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <div className="text-xs font-black text-amber-900 uppercase tracking-wider mb-1">📜 İŞLEM LOGLARI</div>
            <h1 className="text-2xl lg:text-3xl font-black text-slate-900">Sistem & Güvenlik Erişim Kayıtları</h1>
            <p className="text-slate-500 text-xs sm:text-sm mt-1">
              Yöneticilerin panel üzerinde gerçekleştirdiği işlem ve erişim kayıtları.
            </p>
          </div>
